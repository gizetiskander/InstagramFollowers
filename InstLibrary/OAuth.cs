...
namespace InstLibrary
{
    ...
    public class OAuth
    {
        private readonly InstApi config;
        ...
        /// <param name="responseType">Type of the response.</param>
        /// <returns>The authentication url</returns>
        public static string AuthLink(InstApi config, List<Scope> scopes, ResponseType responseType = ResponseType.Token)
        {
            var scopesForUri = BuildScopeForUri(scopes);
